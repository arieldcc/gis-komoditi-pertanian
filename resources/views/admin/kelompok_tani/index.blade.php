@extends('layouts.panel', [
    ...
    'pageSubtitle' => 'CRUD data master kelompok tani.',
])

@section('panel_content')
<div class="panel-card p-3 mb-3">
    <h6 class="fw-semibold">Tambah Kelompok Tani</h6>
    <form method="POST" action="{{ route('admin.kelompok_tani.store') }}" class="row g-2">
        @csrf
...
<div class="table-responsive panel-card p-2">
    <table class="table align-middle mb-0" data-dt-server="true" data-dt-source="admin_kelompok_tani" data-dt-page-length="10">
        <thead>
            <tr>
